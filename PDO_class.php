...
class neoPDO{
  ...
  public $password;
  public $databasename;
  function __construct($databasename='test',$username='root',$password='')
  {
    ...
    try {
      if(new PDO($dsn, $username, $password, $options))echo "$databasename.に接続成功<br>";
    } catch (Exception $e) {
      error_log($e->getMessage());
      exit('接続が失敗しました。'); //something a user can understand
    }
  }
