$(function(){
  $('#button1').on('click',function(e){
      window.location.href='html_showallproduct_template.php';
  })
...
var cache = {}; 
// Cache object 
//創建一個empty assoc array class
var $frame = $('#photo-viewer'); 
//選中有 id='photo-viewer'
// Container for image 
var $thumbs = $('.thumb');
//選中class='thumb' 的element  
// Thumbnails
...
// Pass in new image as parameter 
  ...
  // If there is currently an image showing 
    ...
    // Stop any animation & fade it out 
  } 
  $img.css({ 
...
$(document).on('click', '.thumb', function(e){ 
  ...
  //document指的是 window.document這個object
  //arg2是selector  選中 class='thumb' 的element
  var $img, 
  // Create local variable called $img 
    src = this.href; 
    // this指的是 class='thumb'的element
    // Store path to image 
    request = src; 
    // Store latest image request 
  e.preventDefault(); 
  ...
  // Otherwise it is not in cache 
    ...
    // Store this image in cache 
      ...
      isLoading: true 
      // Set isLoading property to false 
  }; 
  ...
  // When image has loaded 
    $img.hide(); 
    // Hide it 
    // Remove is-loading class from 
    //frame & append new image to it 
