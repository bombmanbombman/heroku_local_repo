...
<ul>
  <li><a class='navi' href="html_login_template.php">Home</a></li>
  ...
  <li style="float:right">
    <select name='forma' onchange="location = this.value">
      ...
      <option value ="html_login_template.php">LOGIN</option>
      ...
      <option value="http://localhost:8012/laravelFolder/resources/views/learning_php">root directory</option>
    </select>
  </li>
</ul>