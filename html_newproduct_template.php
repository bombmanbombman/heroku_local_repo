...
?>
  ...
  <section id='google_map_js'>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAehEZQIPxSSrInvV-wg9MZperouR5Ya5c&libraries=places&region=JP&language=ja&callback=initMap" async defer></script>
