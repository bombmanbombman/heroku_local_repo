...
echo "<br><br><br><div><span id='echo1'>歡迎用戶</span> <var>$user_name</var> <span id='echo2'>回到本站。</span></div>";
if($user_icon != null){
...
// if($progress2===true){
  ...
  // </head>
  // <body>
  // <a href="html_adduserdetail_template.php" ><h1>補充修改用戶詳細信息</h1></a>
  // <br>
  // <br>
  // <br>
  // <a href="html_newproduct_template.php" ><h1>添加新的貨品，輸入貨品基本信息</h1></a>
  // <br>
  // <br>
  // <br>
  // <a href='html_showallproduct_template.php' ><h1>進入全貨號管理頁面</h1></a>
// _HEREDOC;
// }
?>
