...
xhr.onload = function(event) {
  if (xhr.status == 200 && xhr.readyState ==4) {
    ...
    console.log(JSON_String =JSON.stringify(this.response));
    console.log(JSON_object =JSON.parse(JSON_String));
...
console.log(unescaped = unescape(document.cookie));
...
// console.log(JSON__object.quiz.sport.q1.questioin);
$.ajax({
  type: "method",
  url: "url",
  data: "data",
