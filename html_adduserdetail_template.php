...
<input type='eamil' style='width:300px;' value='<?php echo $user_email?>' name='user_email'><br>
<label id='echo3'>請輸入數字，不要自己添加'-'來隔開</label><br>
<input type='tel' value='<?php echo $user_phone?>' pattern="^\d{11}$" 
maxlength ='11' name='user_phone' ><br>
<?php
if(isset($_SESSION['post_error_message'])){
  echo $_SESSION['post_error_message']."<br>";
}else {echo "<br><br>";}
echo"
<label id='echo4'>創建或修改頭像</label><br>
